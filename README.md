...
This repository contains the demo for the SenSys 2024 submission **SecureGaze: Defending Mobile Gaze Estimation Against Backdoor Attacks**. We will make the codes publicly available upon paper acceptance.
